...
module TrainerPokemonProperty
  def self.set(settingname, initsetting)
    ...
    pkmn_properties.concat(
      [[_INTL("Talent"),       AbilityProperty,                         _INTL("Ability of the Pokémon. Overrides the ability index.")],
       [_INTL("Index talent"), LimitProperty2.new(99),                  _INTL("Ability index. 0=first ability, 1=second ability, 2-5=hidden ability.")],
      ...
      if cmd[1] == 0   # Add new Dex
        case pbMessage(_INTL("Fill in this new Dex?"),
           [_INTL("Leave blank"), _INTL("National Dex"),
            _INTL("Nat. Dex grouped families"), _INTL("ANNULER")], 4)
        when 0   # Leave blank
          dex_lists.push([])
          refresh_list = true
