...
MENU_FILE_PATH = "Graphics/Pictures/Pause Menu/"

# An array of aLL the Menu Entry Classes from 005_VoltseonMenu_Entries that
# need to be loaded
MENU_ENTRIES = [
	"MenuEntryPokedex", "MenuEntryPokemon", "MenuEntryBag", "MenuEntryTrainer","MenuEntryPokegear", "MenuEntryMap", "MenuEntryExitBugContest",
